...
public class SCDM_IDAO {
    // 实体
    private static String key = "praiseItem";

    // 实体名称
    private static String keyName = "评论项目得分情况";

    // 包路径
    private static String packge = "com.std.gym.";

    // 表名
    private static String dbname = "tgym_praise_item";

    private static String[] DBwords = { "code", "name", "score", "comment_code" };

    private static String[] DBwordsName = { "编号", "好评项目名称", "得分", "评论编号" };
    ...
    public static void main(String[] args) {
        ...
        File DOMAINfile = new File("C:/Users/asus/Desktop/shan", Key + ".java");

        File Mapperfile = new File("C:/Users/asus/Desktop/shan", Key
                + "Mapper.xml");

        File IDAOfile = new File("C:/Users/asus/Desktop/shan", "I" + Key
                + "DAO.java");

        File DAOImplfile = new File("C:/Users/asus/Desktop/shan", Key
                + "DAOImpl.java");

        File IBOfile = new File("C:/Users/asus/Desktop/shan", "I" + Key
                + "BO.java");

        File BOImplfile = new File("C:/Users/asus/Desktop/shan", Key
                + "BOImpl.java");

        File IAOfile = new File("C:/Users/asus/Desktop/shan", "I" + Key
                + "AO.java");

        File AOImplfile = new File("C:/Users/asus/Desktop/shan", Key
                + "AOImpl.java");
        try {
